    ...
    with mujoco.viewer.launch_passive(m, d) as viewer:
        ...
        while True:
            ...
            if(i % 5 == 0):
                ...
                first, swing_FL_evolution_reference = swing_FL_evolution_reference[:,0], swing_FL_evolution_reference[:,1:]
                swing_FL_evolution_reference = np.concatenate((swing_FL_evolution_reference, swing_FL_evolution_reference_new), axis=1)
